...
CURRENT_USER = 'Zoe'  # Change to your name when you use the script
...
CITY = 'Makeni'  # <-- CHANGE THIS TO SWITCH CITIES
...
def run_data_cleaning():
    ...
    try:
        ...
        delivery_tracker_cleaning.run_filter(
            INPUT_FILE, 
            FILTERED_DATA_FILE,
...
def run_toolbox_generation():
    ...
    try:
        ...
        delivery_tracker_toolbox.run_toolbox(
            most_recent_build,  # Filtered data (BUILD) for problems section
            INPUT_FILE,         # Raw data for statistics section
            TOOLBOX_HTML_FILE, 
            CITY,
            min_deliveries=thresholds['min_deliveries'],
            max_deliveries=thresholds['max_deliveries'],
