...
for filename in files:
    ...
    # Merger sur property_code_assigned (outer join pour garder tous les codes)
    merged = raw.merge(build, on='property_code_assigned', suffixes=('_pre', '_post'), how='outer')
    
    # Remplacer NaN par "missing" pour les deux colonnes
    ...
    # Exclure z042-z043 pour Property_delivery_discovery (sauf si missing)
