...
PRODUCTIVITY_THRESHOLDS = {
    'Freetown': {'min_deliveries': 55, 'max_deliveries': 85},
...
if CURRENT_USER == 'Ibrahim':
    CODE_PATH     = os.path.join(USER_ROOT_PATH, r'11. Code\Python\2. Delivery')
    RAW_DATA_PATH = os.path.join(USER_ROOT_PATH, CITY)
    OUTPUT_PATH   = os.path.join(USER_ROOT_PATH, r'13. Output')
else:
