...
*==============================================================================*
	...
	import excel "${Input}/Kenema/RDN/property_rates_payments.xlsx", ///
		firstrow clear
	save "${Build}/Kenema/RDN/KCC_revenue_RDN.dta", replace
...
use "${Build}/Kenema/RDN/KCC_revenue_RDN.dta", clear
...
*==============================================================================*
	...
	import excel "${Input}/Kenema/Business/business_license_payments.xlsx", ///
					firstrow clear
	save "${Build}/Kenema/Business/KCC_revenue_business_license.dta", replace
...
use "${Build}/Kenema/Business/KCC_revenue_business_license.dta", clear
...
*------------------------------------------------------------------------------*  
	...
	rename operator bank
	rename transactionid bank_ref
	keep paymentdate license_code bank_ref totalpayable amountpaid property_code businesscategory businesssubcategory bank
	rename paymentdate date
	rename totalpayable total_payable
	rename amountpaid payment_amount
...
append using "${Build}/Kenema/RDN/KCC_revenue_RDN.dta"
save "${Final}/Kenema/KCC_revenue_analysis.dta", replace
